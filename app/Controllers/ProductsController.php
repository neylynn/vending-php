...
class ProductsController
{
     ...
     * - In normal web requests: sends Location header + exit.
     * - In PHPUnit: sends Location header but does NOT exit,
     *   and records the URL for assertions.
     */
    ...
    public function create()
    {
        ...
        if ($errors) {
            // Echo errors so the PHPUnit test can see them in buffer
